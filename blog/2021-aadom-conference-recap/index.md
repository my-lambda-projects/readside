...
<img src="data:image/svg+xml;nitro-empty-id=NDQwOjY4Mw==-1;base64,PHN2ZyB2aWV3Qm94PSIwIDAgNzYwIDQwMCIgd2lkdGg9Ijc2MCIgaGVpZ2h0PSI0MDAiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyI+PC9zdmc+" title="Our Marketing Masterclass helped attendees create a 12-month marketing action plan for the coming year." alt="Snapshots of our marketing masterclass at the AADOM conference" id="NDQwOjY4Mw==-1" class="alignnone wp-image-53132 size-full nitro-lazy" sizes="(min-width: 0px) and (max-width: 480px) 480px, (min-width: 481px) 760px, 100vw" width="760" height="400" />
...
<img src="data:image/svg+xml;nitro-empty-id=NDQzOjU4Nw==-1;base64,PHN2ZyB2aWV3Qm94PSIwIDAgNzYwIDQwMCIgd2lkdGg9Ijc2MCIgaGVpZ2h0PSI0MDAiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyI+PC9zdmc+" alt="Whitney and Angela teaching during our Marketing Masterclass Workshop" id="NDQzOjU4Nw==-1" class="alignnone size-full wp-image-53133 nitro-lazy" sizes="(min-width: 0px) and (max-width: 480px) 480px, (min-width: 481px) 760px, 100vw" width="760" height="400" />
...
Afterward, Angela and I answered some of the questions, but time prevented us from covering them all. After we got back, we wanted to make sure to answer ALL of the great questions attendees had about their marketing, so we filmed a quick video to do so. In it we answered questions about reviews, getting your team involved in marketing, and more. It’s super valuable information for ANY practice, so we made it available to everyone! 👇 Watch below or [click here](https://youtu.be/ofhR0YurnEc) to watch on YouTube.
